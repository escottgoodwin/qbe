    ...
    InfoCommand.prototype.printStage = function (name, stage, cluster, secrets, workspace, printJson) {
        ...
        if (printJson) {
            var result = {
                ...
                workspace: workspace,
                httpEndpoint: prisma_yml_1.getEndpoint(cluster, name, stage, workspace),
                wsEndpoint: prisma_yml_1.getWSEndpoint(cluster, name, stage, workspace),
            };
            if (secret) {
        ...
        return "\n  " + chalk_1.default.bold(stage) + " (cluster: " + chalk_1.default.bold("`" + cluster.name + "`") + ")\n\n    HTTP:       " + prisma_yml_1.getEndpoint(cluster, name, stage, workspace) + "\n    Websocket:  " + prisma_yml_1.getWSEndpoint(cluster, name, stage, workspace);
    };
