...
var Deploy = /** @class */ (function (_super) {
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 13:
                        ...
                        _c.label = 14;
                    case 14: return [4 /*yield*/, this.client.initClusterClient(cluster, workspace, serviceName, stage)];
                    case 15:
                        _c.sent();
    ...
    Deploy.prototype.printEndpoints = function (cluster, serviceName, stageName, workspace) {
        this.out.log("\n" + chalk_1.default.bold('Your Prisma GraphQL database endpoint is live:') + "\n\n  " + chalk_1.default.bold('HTTP:') + "  " + prisma_yml_1.getEndpoint(cluster, serviceName, stageName, workspace) + "\n  " + chalk_1.default.bold('WS:') + "    " + prisma_yml_1.getWSEndpoint(cluster, serviceName, stageName, workspace) + "\n");
    };
