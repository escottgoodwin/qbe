...
var PrismaDefinitionClass = /** @class */ (function () {
    ...
    PrismaDefinitionClass.prototype.getCluster = function (throws) {
        ...
        if (this.definition && this.endpoint) {
            var _a = parseEndpoint(this.endpoint), clusterBaseUrl = _a.clusterBaseUrl, isPrivate = _a.isPrivate, local = _a.local, shared = _a.shared, workspaceSlug = _a.workspaceSlug, clusterName_1 = _a.clusterName;
            if (clusterBaseUrl) {
...
function parseEndpoint(endpoint) {
    ...
    var local = isLocal(url.origin);
    var isPrivate = !shared && !local;
...
function getWSEndpoint(cluster, service, stage, workspace) {
