...
var PostgresConnector = /** @class */ (function () {
    ...
    PostgresConnector.prototype.queryTables = function (schemaName) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.client.query("select table_name, column_name, is_nullable, data_type, udt_name from information_schema.columns where table_schema = $1::text", [schemaName.toLowerCase()])];
                    case 1:
                        res = _a.sent();
                    ...
                    case 3:
                        ...
                        withColumns = _.map(tables, function (originalColumns, key) {
                            var columns = _.map(originalColumns, function (column) {
                                var _a = _this.toTypeIdentifier(column.data_type), typeIdentifier = _a.typeIdentifier, comment = _a.comment, error = _a.error;
    ...
    PostgresConnector.prototype.toTypeIdentifier = function (type) {
        if (type === 'character') {
